/************************************************************* 
* programa: benchNIOSII2021_Parte1.s (ver 1.0)
*
* AC - Practica 3
*
* Programa para medidas de prestaciones de NIOS II/{e, f}
* Mide el tiempo en ciclos de reloj que el procesador tarda en ejecutar un 
* nucleo-kernel de computo repetidas veces.
*
* subrutinas: PRODUCTO_ESCALAR, ESCRIBIR_JTAG, activaTimer, desactivaTimer, PRINT_JTAG
*
* ficheros: DIV.s, JTAG2021.s, productoEscalar.s, BCD.s, nios_macros.s
*
...
/* zona de inicializaciones del benchmark */
	add  	r5, r0, r0		/* numero iteraciones realizadas de benchmark */
...
hazCall:
	call PRODUCTO_ESCALAR		/* kernel de computo */
	addi 	r5, r5, 1			/* i++ */
