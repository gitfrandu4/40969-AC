...
********************************************************************************/
.extern 	NiterRealizadas
.extern 	TIEMPOacumulado 
.extern 	tiempoTotal_acumulado
...
/*
	movia 	r3, TEXTO
	call 	ESCRIBE_TEXTO_JTAG	
	movia 	r17, TIEMPOacumulado 	
	ldw   	r4, 0(r17)
	call  	BCD			 
	call 	ESCRIBE_VALOR_JTAG	
*/

	movia 	r3, TEXTO2
	call 	ESCRIBE_TEXTO_JTAG

	movia 	r17, NiterRealizadas		/* direccion base del contador de intervalos del Timer */
	ldw   	r4, 0(r17)
	...
	movia 	r17, tiempoTotal_acumulado 	/* direccion base del contador de intervalos del Timer */
	ldw   	r4, 0(r17)
	call  	BCD			/* r4= valor binario, r2= valor BCD */
	...
	movia 	r3, TEXTO4	/* mensaje de salida */
	call 	ESCRIBE_TEXTO_JTAG
...
*/
TEXTO2:
.asciz 	"\nNumero de iteraciones del kernel= "
TEXTO3:
