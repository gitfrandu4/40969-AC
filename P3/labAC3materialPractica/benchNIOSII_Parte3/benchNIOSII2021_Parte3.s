/************************************************************* * benchNIOSII2021.s (ver 1.0)
*
* AC - Practica 3 - Parte 3
*
* benchNIOSII_Parte3.s
*
* Programa para evaluar el efecto de la tecnica software de reordenacion de
* instrucciones sobre el tiempo de ejecucion.
*
* subrutinas: BYPASSING, ESCRIBIR_JTAG, activaTimer, desactivaTimer, PRINT_JTAG 
*
* ficheros: DIV.s, JTAG2021.s, bypassing.s, BCD.s, nios_macros.s
*
...
hazCall:
	call 	BYPASSING		/* kernel de computo */
	addi 	r5, r5, 1		/* i++ */
